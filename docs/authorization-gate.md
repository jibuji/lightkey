...
- **已知边界（#71/#74/#77 已拍板承认，补充拍板 #15；issue #65 的收紧项按
  补充拍板 #19 部分闭环、其余维持推迟）**：
  ...
  - **#65-B 其余，仍按补充拍板 #15 推迟**：按调用方区分能力面 / 常驻进程持令牌
    （#68 选项 2）等收紧方案，仅在威胁模型升级（多 Agent 互不信任成为产品前提）
    时打包立 spec、不单独零敲；2026-08-27 复审维持该处置（威胁模型不变）。
